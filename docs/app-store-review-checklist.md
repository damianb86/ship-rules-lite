...
- [ ] Scopes are minimal: read_products, read_delivery_customizations, write_delivery_customizations, read_validations, write_validations.
...
- [ ] Known limitation disclosed: MVP is visual and Admin App Home with future Shopify Functions extensions.
